...
//@function_name: Create_RootMenu
//@function_function:  创建目录链表根节点
...
//@function_name: Create_Menu
//@function_function:  创建目录链表
//@Input_variable:      输入变量名及格式
//@output_variable：  输出变量及类型
//@version ：V1.0     版本
//@Last_modification_time:最后修改时间
...
//@function_name: Create_NextMenu
//@function_function:  创建下级菜单列表项
//@Input_variable:      输入变量名及格式
//@output_variable：  输出变量及类型
//@version ：V1.0     版本
//@Last_modification_time:最后修改时间
...
//@function_name: Create_Equal_NextMenu
//@function_function:  创建下级菜单列表项
//@Input_variable:      输入变量名及格式
//@output_variable：  输出变量及类型
//@version ：V1.0     版本
