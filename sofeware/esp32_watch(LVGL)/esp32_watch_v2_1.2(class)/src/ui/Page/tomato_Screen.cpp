...
extern lv_obj_t * tomato_Screen;  //三级页面 闹钟，暂不提供闹钟设置


//�������ӣ��б���ʽ
void ui_tomato_Screen(void)
{
    ...
    lv_obj_set_scrollbar_mode(tomato_Screen, LV_SCROLLBAR_MODE_OFF);


    // ʱ�� Сʱ
    lv_obj_t *time_hour_text = lv_label_create(tomato_Screen);
    ...
    // ð��
     lv_obj_t *time_maohao1_text = lv_label_create(tomato_Screen);
...
//    // ʱ�����
    lv_obj_t *time_min_text = lv_label_create(tomato_Screen);
    ...
    // ð��
    lv_obj_t *time_maohao2_text = lv_label_create(tomato_Screen);
    ...
    lv_obj_align(time_maohao2_text, LV_ALIGN_CENTER, 35, -10);
      ...
      // ��
    lv_obj_t *time_sec_text = lv_label_create(tomato_Screen);
    ...
    lv_obj_t* imgbtn1 = lv_imgbtn_create(tomato_Screen);
